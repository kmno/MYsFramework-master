...
//                let components: [CGFloat] = [ oldComponents![0], oldComponents![0], oldComponents![0], oldComponents![1]]
                let colorRef = UIColor.red.cgColor  //(colorSpace: colorSpaceRGB, components: components)
...
//                let components: [CGFloat] = [ oldComponents![0], oldComponents![0], oldComponents![0], oldComponents![1]]
                let colorRef = UIColor.red.cgColor // CGColor(colorSpace: colorSpaceRGB, components: components)
                let colorOut = Color(cgColor: colorRef)
                return colorOut
            } else {
                return color
